...
public class IoLib extends TwoArgFunction {
	...
	static final class IoLibV extends VarArgFunction {
		...
		public Varargs invoke(Varargs args) {
			try {
				...
				case IO_POPEN:		return iolib._io_popen(args.checkJString(1),args.optionalJString(2,"r"));
				case IO_OPEN:		return iolib._io_open(args.checkJString(1), args.optionalJString(2,"r"));
				...
				case FILE_SETVBUF:	return iolib._file_setvbuf(args.arg1(),args.checkJString(2),args.optionalInt(3,8192));
				case FILE_LINES:	return iolib._file_lines(args);
				case FILE_READ:		return iolib._file_read(args.arg1(),args.subArgs(2));
				case FILE_SEEK:		return iolib._file_seek(args.arg1(),args.optionalJString(2,"cur"),args.optionalInt(3,0));
	...
	public Varargs _io_lines(Varargs args) {
		String filename = args.optionalJString(1, null);
