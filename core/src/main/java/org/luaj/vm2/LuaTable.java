...
public class LuaTable extends LuaValue implements Metatable {
	...
	public LuaTable optionalTable(LuaTable defval)  {
		return this;
	}
	...
	public void rawset( LuaValue key, LuaValue value ) {
		if ( !key.isInteger() || !arrayset(key.toInt(), value) )
			hashset( key, value );
	}
